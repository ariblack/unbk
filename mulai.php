...
//  $user = $_COOKIE['PESERTA'];
//  setcookie('PESERTA',$user);
$sqluser = mysqli_query($sqlconn_i, "SELECT s.*,u.*,s.XKodeKelas as kelassiswa,m.XNamaMapel FROM  `cbt_siswa` s LEFT JOIN cbt_ujian u ON s.XKodeKelas = u.XKodeKelas
                            ...
                            <div class="page-col-left col-centered">
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item">
                                        ...
                                        <p class="list-group-item-text"><?php echo "$xkodesoal"; ?></p>
                                    ...
                                    <div class="list-group-item">
                                        ...
                                        <p class="list-group-item-text"><?php $b = $xstatusujian = 1 ? "AKTIF" : "TIDAK";
                                                                        echo "<strong>$b</strong>"; ?></p>
