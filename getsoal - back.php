...
$sql = mysqli_query($sqlconn_i, "SELECT j.Urut as Urut, j.XJawaban as XJawaban , c.XNomerSoal as XNomerSoal, j.XRagu as XRagu
FROM  `cbt_soal` c
...
<label class="labele"><input type="checkbox" id="<? echo $stu; ?>" onClick="toggle_select(<? echo $stu; ?>)" <? echo $ragu; ?> />
        &nbsp;&nbsp;&nbsp;RAGU-RAGU</label>
                ...
                <script>
                   ...
                   <? $cekragu = mysqli_num_rows(mysqli_query($sqlconn_i, "select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'")); 
 					  if($cekragu>0){ ?>
