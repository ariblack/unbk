         ...
         <div class="portlet light bordered">
             ...
             <div class="portlet light bordered">
                 <div class="portlet-title">
                     ...
                     <div class="actions">
                         <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal3" title="Tambah Mapel" data-toggle="modal">
                             <i class="icon-action-redo"></i>
                         </a>
                         <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal5" title="Upload Mapel" data-toggle="modal">
                                 ...
                                 <tbody>
                                     <tr>
                                         ...
                                         <td>
                                             ...
                                             <a class="btn btn-primary btn-sm" href="index.php?page=edit_mapel&id=<?php echo $nom ?>" title="Edit Mapel" data-toggle="modal">Edit
                                 ...
                                 <div class="modal-body">
                                     <form action="index.php?page=tmapel" class="form-horizontal" method="post">
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-8">
                                                 <input name="kodemapel" class="form-control input-medium date-picker" size="16" type="text" value="">
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label class="control-label col-md-4">Nama Mapel</label>
                                             <div class="col-md-8">
                                                 <input name="namamapel" class="form-control input-medium date-picker" size="16" type="text" value="">
                                             </div>
                                         </div>
                                         <div class="modal-footer">
                                             <button class="btn dark btn-outline" data-dismiss="modal" aria-hidden="true">Close</button>
                             ...
                             <div class="modal-body">
                                 <form action="index.php?page=edit_mapel" class="form-horizontal" method="post">
                                     <div class="form-group">
                                         <label class="control-label col-md-4">Kode Mapel</label>
                                         <div class="col-md-8">
                                             <input name="kodemapel" class="form-control input-medium date-picker" size="16" type="text" value="<?php echo $kode ?>">
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label class="control-label col-md-4">Nama Mapel</label>
                                         <div class="col-md-8">
                                             <input name="namamapel" class="form-control input-medium date-picker" size="16" type="text" value="<?php echo $nama ?>">
                                         </div>
                                     </div>
                                     <div class="modal-footer">
                                         <button class="btn dark btn-outline" data-dismiss="modal" aria-hidden="true">Close</button>
