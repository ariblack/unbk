         ...
         <div class="portlet light bordered">
             ...
             <div class="portlet light bordered">
                 <div class="portlet-title">
                     ...
                     <div class="actions">
                         <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal2" title="Tambah Kelas" data-toggle="modal">
                             <i class="icon-action-redo"></i>
                         </a>
                         <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal4" title="Upload Kelas" data-toggle="modal">
                            ...
                            ?>
                                 <tbody>
                                     <tr>
                                         ...
                                         <td>
                                             <a class="btn btn-primary btn-sm" href="index.php?page=edit_kelas&id=<?php echo $nom ?>" title="Edit Kelas" data-toggle="modal">Edit
                                             </a>
                                             <a class="btn btn-danger btn-sm" href="hapus_kelas.php?id=<?php echo $mhs0['Urut']; ?>" onclick="return confirm('Anda Yakin akan menghapus data Kelas ini?')" title="Hapus Kelas"> Hapus
                                             </a>
                                     ...
                                     <div class="modal-body">
                                         <form action="index.php?page=tkelas" class="form-horizontal" method="post">
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <div class="col-md-8">
                                                     <input name="kodekelas" class="form-control input-medium date-picker" size="16" type="text" value="">
                                                 </div>
                                             </div>
 ...
 <div id="form_modal4" class="modal fade" role="dialog" aria-hidden="true" style="display: none;">
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                 <h4 class="modal-title">Upload Data Kelas</h4>
             </div>
             <div class="modal-body">
