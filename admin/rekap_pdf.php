...
$result = mysqli_query($sqlconn_i, "SELECT *,u.XStatusUjian as ujsta
FROM cbt_siswa s
...
WHERE c.XStatusUjian = '1'") or die(mysqli_error($sqlconn_i));
...
$pdf = new FPDF('P','mm',array(310,310)); //L For Landscape / P For Portrait
$pdf->AddPage();
