...
$sqltoken = mysqli_query($sqlconn_i, "SELECT * FROM cbt_ujian where XStatusUjian = '1'");
...
?>
                                <tr height="40px">
                                    ...
                                    <td width="5%" align="center"><a href="jawabansiswaessay.php?nomer=<?php echo $nouji; ?>&ujian=<?php echo "$soaluji"; ?>" target="_blank"><img src="images/printer.png"/></a></td>
                                    </td>
                                </tr>
