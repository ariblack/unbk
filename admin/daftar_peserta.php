    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal2" title="Tambah Peserta" data-toggle="modal">
                        <i class="icon-action-redo"></i>
                    </a>
                    <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal3" title="Upload Peserta" data-toggle="modal">
                    ...
                    <div class="row">
                        <table class="table table-striped table-hover">
                            ...
                            if (isset($sqlconn_i)) {
                                ...
                                $result0 = mysqli_query($sqlconn_i, $sql0);
                                while ($mhs0 = mysqli_fetch_array($result0)) {
                                    $nom = $mhs0['Urut'];
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-sm" href="index.php?page=edit_peserta&id=<?php echo $nom ?>" title="Edit Peserta" data-toggle="modal">Edit
                                                </a>
                                                <a class="btn btn-danger btn-sm" href="hapus_peserta.php?id=<?php echo $mhs0['XNomerUjian']; ?>" onclick="return confirm('Anda Yakin akan menghapus data peserta ini?')" title="Hapus Peserta" > Hapus
                                                </a>
                                            </td>
                                        </tr>
                                ...
                                <div class="modal-body">
                                    <form action="index.php?page=tsiswa" class="form-horizontal" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input name="nomor" class="form-control input-medium date-picker" size="16" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Nama Peserta</label>
                                            <div class="col-md-8">
                                                <input name="nama" class="form-control input-medium date-picker" size="16" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input name="nik" class="form-control input-medium date-picker" size="16" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Password</label>
                                            <div class="col-md-8">
                                                <input name="password" class="form-control input-medium date-picker" size="16" type="password" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
