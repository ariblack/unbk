        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a class="btn btn-circle btn-icon-only btn-default" href="#form_modal5" title="Upload Soal" data-toggle="modal">
            ...
            <table class="table table-striped table-hover">
                ...
                if (isset($sqlconn_i)) {
                    $no1 = 1;
                    $sql01 = "select DISTINCT XKodeSoal,XKodeMapel,Xidacak from cbt_soal order by XKodeSoal asc";
                ...
                ?>
                        <tbody>
                            <tr>
                                ...
                                $result012 = mysqli_query($sqlconn_i, $sql012);
                                while ($mhs012 = mysqli_fetch_array($result012)) {
                                ?>
                                    <td> <?php echo $mhs012['XNamaMapel']; } ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-warning btn-sm" href="b.php?id=<?php echo $mhs01['XKodeSoal']; ?>" title="Backup Soal" onclick="return confirm('Anda Yakin akan membackup Soal ?')"> Backup
                                        </a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="tambahsoal/multi.php">
                                <label>Paket : </label> <select name="kodesoal">
                                    <?php
                                    //                                $conn = $sqlconn_i;
                                    // mysqli_select_db("cbt",$conn);
                                    $sqlkelas = mysqli_query($sqlconn_i, "select distinct XKodeSoal from cbt_soal order by XKodeSoal");
                ...
                <div class="modal-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="post" enctype="multipart/form-data" action="uploadsoal/proses_soal.php">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" border="0">
                                <tr>
                                    <td>
                                        Excel File : <input name="userfile" type="file" class="btn btn-danger"></td>
                                    <td>
                                    </td>
                                </tr>
                                <tr>
