									...
									<tr height="40px">
										...
										<td>
											<select name="txt_level" id="txt_level" class="form-control input-large input-inline">
												...
												$sqlkelas = mysqli_query($sqlconn_i, "select * from cbt_kelas where XStatusKelas = '1' order by Urut");
												while ($sk = mysqli_fetch_array($sqlkelas)) {
									...
									<tr height="40px">
										...
										<td>
											<select name="txt_ujian" id="txt_ujian" class="form-control input-large input-inline">
												...
												$sqltes = mysqli_query($sqlconn_i, "select * from cbt_ujian where XStatusKelas = '1' order by XKodeKelas");
												while ($sk = mysqli_fetch_array($sqlkelas)) {
