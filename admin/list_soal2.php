<div class="row">
  <div class="col-md-12">
    <div class="portlet light bordered">
      ...
      $sql011 = "select DISTINCT XKodeMapel,XKodeSoal,XKkm,XPilSoal from cbt_soal where XKodeSoal = '" . mysqli_real_escape_string($sqlconn_i, $_GET['id']) . "' order by Urut asc";
      $result011 = mysqli_query($sqlconn_i, $sql011);
      if (!$result011) {
        die("Query failed: " . mysqli_error($sqlconn_i));
      }
      while ($mhs011 = mysqli_fetch_array($result011)) {
        ...
        <table class="table table-bordered">
          <tr>
            ...
            <td width="468" valign="top"><strong>:
                ...
                $result0111 = mysqli_query($sqlconn_i, $sql0111);
                $mhs0111 = mysqli_fetch_array($result0111);
                echo $mhs0111['XNamaMapel']; ?> | KKM : <font color="#FF0000"> <?php echo $mhs011['XKkm']; ?></font>
                <br>
                : <?php echo $mhs011['XKodeSoal']; ?></strong>
              <br />
              <strong>:<font color="#FF0000"> <?php echo $mhs011['XPilSoal']; ?></font></strong>
            </td>
  ...
  <table class="table">
    <tr>
      ...
      <td class="info"><strong><a href="index.php?page=ubah_soal&id=<?php echo $mhs01['Urut']; ?>">Edit</a></strong> | <strong><a href="index.php?page=hapus_persoal&id=<?php echo $mhs01['Urut']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Soal ini ? ')">Hapus</a><br />
          ...
          ?>: <a href="index.php?page=ubah_tysoal&id=<?php echo $mhs01['Urut']; ?>&<?php echo $ks; ?>">Ubah</a></strong></td>
    </tr>
    <tr>
