...
if (isset($_POST['keterangan']))
{
	...
	if ($keterangan=="" || $nama_file=="")
	{
		...
		if (move_uploaded_file($_FILES['datafile']['tmp_name'],$alamatfile))
		{
			...
			$upload=mysqli_query($sqlconn_i, "INSERT INTO cbt_tabel_data(nama_file,ukuran,url,tgl_upload,keterangan) VALUES('$nama_file','$ukuran','$alamatfile','$tanggal2','$keterangan')");
