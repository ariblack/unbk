...
WHERE c.XStatusUjian = '1'");
    ...
    while ($s = mysqli_fetch_array($sql)) {
        ...
        if ($staujian == '0') {
            $staujian = "Belum Login";
        } elseif ($staujian == '1') {
            $staujian = "Sedang Dikerjakan";
        } elseif ($staujian == '9') {
            $staujian = "Tes SELESAI";
        }
    ?>
        <tr height="40px">
            ...
            <td width="20%">
                <a class="btn btn-success btn-small" href="reset_peserta.php?id=<?php echo $nouji; ?>" onclick="return confirm('Tombol ini akan Mereset Ujian Siswa Yang anda pilih, Anda Yakin ?')">Reset</a>
                <a class="btn btn-danger btn-small" href="logout_peserta.php?id=<?php echo $nouji; ?>" onclick="return confirm('Tombol ini akan membuat siswa yang anda pilih akan logout, untuk melanjutkan nya lagi silahkan reset siswa,')">Logout</a>
            </td>
        </tr>
