...
-->
    ...
    <head>
        ...
        <link rel="shortcut icon" href="../admin/images/icon.ico">
    </head>
    <!-- END HEAD -->
                ...
                <div class="container-fluid">
                    <div class="havbar-header">
                        ...
                        <div class="topbar-actions" style="margin-right:30px">
                            <div class="topbar-actions" style="margin-right:30px">
                                <H3><a class="btn red" href="#form_modal24" title="Ubah" data-toggle="modal"><i class="icon-user"></i> UBAH PASSWORD</a>
                                </H3>
                                            ...
                                            <div class="modal-body">
                                                <form action="index.php" class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input name="usr" class="form-control input-medium date-picker" size="16" type="text" value="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4">Password</label>
                                                        <div class="col-md-8">
                                                            <input name="pas" class="form-control input-medium date-picker" size="16" type="password" value="">
                                                        </div>
                                                    </div>
            ...
            <div class="page-content page-content-popup">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            <li class="nav-item  ">
                                ...
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    ...
                                    <span class="title">List Daftar</span>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="index.php?page=daftar_hadir" class="nav-link">
                                            <i class="icon-docs"></i>
                                            <span class="title">Daftar Hadir</span>
                                        </a>
                                    <li class="nav-item">
                                        <a href="index.php?page=berita_acara" class="nav-link">
                                            <i class="icon-docs"></i>
                ...
                <div class="page-fixed-main-content">
                    ...
                    <?php if (!isset($_GET["page"])) {
                        ...
                        } else if ($_GET['page'] == "berita_acara") {
                            require "bo.php";
...
<![endif]-->
    ...
    <!-- FOOTER -->
    <div class="well well-sm" align="center"><a href="http://wokaproject.id">WOKA</a><span><b> Version 20.26</b></div>
