    ...
    ?>
      <table width="806" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td>jawaban 1.
            <textarea name="a" type="text" id="textfield9" size="50"><? echo $mhs01['XJawab1']; ?> </textarea>
          </td>
        </tr>
        <tr>
          <td height="28" align="center">&nbsp;</td>
          <td>Jawaban 2.
            <textarea name="b" id="textfield5"><? echo $mhs01['XJawab2']; ?> </textarea>
          </td>
        </tr>
        <tr>
          <td height="31" align="center">&nbsp;</td>
          <td>Jawaban 3.
            <textarea name="c" type="text" id="textfield11" size="50"><? echo $mhs01['XJawab3']; ?></textarea>
          </td>
        </tr>
        <tr>
          <td height="32" align="center">&nbsp;</td>
          <td>Jawaban 4.
            <textarea name="d" type="text" id="d" size="50"><? echo $mhs01['XJawab4']; ?></textarea>
          </td>
        </tr>
        <tr>
          <td height="32" align="center">&nbsp;</td>
          <td>Jawaban 5.
            <textarea name="e" type="text" id="textfield12" size="50"><? echo $mhs01['XJawab5']; ?></textarea>
          </td>
        </tr>
        <tr>
