...
if (isset($_GET['id'])) {
	...
	die("Kesalahan. Tidak Ada Kelas Terpilih! ");
}
...
if (isset($_POST['update'])) {
	...
	//echo $kodelevel . " - " . $levelkelas . " - " . $kodekelas;
	$query = "UPDATE cbt_kelas SET XKodeLevel='$xkodelevel',XLevelKelas='$xlevelkelas',XKodeKelas='$xkodekelas',XStatusKelas='1' WHERE Urut='$nom'";
	$sql = mysqli_query($sqlconn_i, $query);
	if ($sql) {
