...
<body>
  ...
  '$user' and u.XStatusUjian = '1'");
                ...
                $sql = mysqli_query($sqlconn_i, "SELECT j.XNomerSoal as Urut, j.XJawaban as XJawaban , c.XNomerSoal as XNomerSoal, j.XRagu as XRagu
FROM  `cbt_soal` c
...
AND j.XKodeSoal = c.XKodeSoal ) where c.XKodeSoal = '$xkodesoal' and j.XUserJawab = '$user' and j.XTokenUjian = '$xtokenujian' order by j.XNomerSoal");
                ...
                ?>
                    ...
                    ?>
                    <?php echo '<a href="#" data-id="' . $s['Urut'] . '" class="get_pic">'; ?>
                    <div class="item" style="background-color:<?php echo $cssb; ?>; color:<?php echo $csst; ?>;border-color:<?php echo $border; ?>">
...
//Connect to Database
//$sqlj = mysqli_query("SELECT * from cbt_jawaban where Urut = '$_POST[pic]' and XKodeSoal = '$xkodesoal' and XUserJawab = '$user'");
...
$sql = mysqli_query($sqlconn_i, "SELECT Urut FROM cbt_jawaban WHERE Urut > '$current_picture' and XKodeSoal = '$xkodesoal'
...
!-->
        ...
        <label class="drinkcard-cc E" for="E">&nbsp;</label></td><td class="pilihanjawaban"><?php echo "$result[XJawab5]"; ?></td></tr>
        </table>
!-->
        ...
        <label class='drinkcard-cc D' for='D'>&nbsp;</label></td><td class='pilihanjawaban'>$jwbD </td></tr>
  		<tr><td valign='top'><input id='E' type='radio' name='credit-card' value='E' $nilaiE >
        <label class='drinkcard-cc E' for='E'>&nbsp;</label></td><td class='pilihanjawaban'>$jwbE </td></tr>
        </table>";
                } else {
                    $se = $sj['XEssay'];
                    echo "	<form method='post' class='form-jwb'><input type='hidden' name='o' value='O'/>	<input id='soale' type='hidden' name='soale' value='$current_picture'/>";
                    echo "<strong>Jawaban :</strong><br><textarea  cols='80' rows='6' name='esse' >$se</textarea><br><input type='submit' class='tombol-simpan' value='simpan' name='jawab'></form>";
                }
                ?>
