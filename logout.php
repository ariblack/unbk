...
$tgl = date("H:i:s");
isset($_COOKIE['PESERTA']) ? $user = $_COOKIE['PESERTA'] : $user="";
//$user = $_COOKIE['PESERTA'];
$sql = mysqli_query($sqlconn_i, "Update cbt_siswa_ujian set XStatusUjian = '9',XLastUpdate = '$tgl' where XNomerUjian = '$user' and XStatusUjian = '1'");
